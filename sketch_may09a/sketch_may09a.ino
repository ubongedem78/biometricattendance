...
const char* device_token  = "8b5ba317";
//************************************************************************
String getData, Link;
String URL = "http://192.168.1.178/biometricattendancev2/getdata.php"; //computer IP or the server domain
//************************************************************************
...
void SendFingerprintID(int finger) {
  ...
  if (WiFi.isConnected()) {
    ...
    Serial.println("HTTP request initiated");
